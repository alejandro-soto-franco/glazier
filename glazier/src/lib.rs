...
//!
//! Named after James Glazier, whose work with Graner and Hogeweg made the
//! Potts lattice a model of tissue.
//!
...
//! the facade over both, and the binary that runs a Blueprint.
